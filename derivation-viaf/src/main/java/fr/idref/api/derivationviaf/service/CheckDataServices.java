...
public class CheckDataServices {
    ...
    public boolean isSolrDosntExist(SolrDoublon solr)    {return (solr.getResponse() != null && solr.getResponse().getNumFound() == 0);}
...
public String getRecord(String xml)
{
    ...
    public boolean isUriSourceViaf(String uriSourceViaf) {
        ...
        String find = "(?:http|https)://(?:www\\.)?viaf.org/(?:.*/)?processed/(.*)";
